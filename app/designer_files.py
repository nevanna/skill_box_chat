...
################################################################################
## Form generated from reading UI file 'designer_files.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.message_box = QTextBrowser(self.centralwidget)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.message_input.setPlaceholderText(QCoreApplication.translate("MainWindow", u"type your message", None))
